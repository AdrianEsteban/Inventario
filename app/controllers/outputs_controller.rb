class OutputsController < ApplicationController
  ...
  def create
    ...
    var = entry[:products_id] 
     puts "#{var} id de productos**************************************************************###}"
    #Encuentra el id del prodsucto y saca la cantidad de ese producto
    ...
    #cantidad a salir
    qu_out = @output.quantity_ouput
    #hace la resta
    outputs = cant_product - qu_out  
    puts "#{outputs} resta del 33333**************************************************************###}"   
    #y se lo asigna a la cantidad de los productos
     @product.quantity = outputs
     @product.save
    ...
    respond_to do |format|
      if @output.save
        format.html { redirect_to url, notice: 'Output was successfully created.' }
  ...
  private
    ...
    def output_params
      params.require(:output).permit( :products_id, :quantity_ouput)      
    end
